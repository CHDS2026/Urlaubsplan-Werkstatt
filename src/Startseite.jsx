...
export default function Startseite({ onGo, trips, ideen }) {
  ...
  const karte = "flex w-full items-start gap-3 rounded-2xl border border-stone-200 bg-white p-3 text-left shadow-sm transition hover:border-emerald-300 hover:shadow-md dark:border-stone-700 dark:bg-stone-900 dark:hover:border-emerald-700";
  ...
  return (
    <div className="space-y-4">
      <section className="rounded-2xl border border-emerald-200 bg-gradient-to-br from-emerald-50 to-white p-4 shadow-sm dark:border-emerald-800 dark:from-emerald-950 dark:to-stone-900">
        <h1 className="text-xl font-bold tracking-tight text-stone-900 dark:text-stone-50">Urlaubsplaner</h1>
