...
import { STYLE_KARTE, STYLE_SAT, addWege, removeWege } from "./lib/karte.js";
...
export default function Wegkarte({ geojson, name, selectedId, onSelect, hoehe, spots }) {
  ...
  // Gewähltes Ziel + stabiler Koordinaten-Schlüssel. MUSS vor den Effekten stehen, die
  // selCoordKey als Abhängigkeit nutzen – sonst „Cannot access 'selCoordKey' before
  // initialization" (schwarzer Bildschirm). selectedId/spots kommen aus den Props.
