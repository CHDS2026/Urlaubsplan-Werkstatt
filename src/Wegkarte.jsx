...
function distZuRoute(geojson, lat, lon) {
  ...
  for (const feat of (fc.features || [])) {
    const cs = (feat.geometry && feat.geometry.coordinates) || [];
    for (const c of cs) { if (!Array.isArray(c) || c.length < 2) continue; const d = havM(lat, lon, c[1], c[0]); if (d < best) best = d; }
  }
