...
import { Navigation, Footprints, Bike, Search, MapPin, Loader2, Info, X, Crosshair } from "lucide-react";
...
export default function RoutePlaner() {
  ...
  useEffect(() => {
    ...
    map.on("click", (e) => { if (modusRef.current === "karte") setZielPunkt({ lat: e.lngLat.lat, lon: e.lngLat.lng, name: "Kartenpunkt" }); });
    ...
    <div className="rounded-2xl border border-stone-200 bg-white p-4 dark:border-stone-800 dark:bg-stone-900">
      ...
      <div className="mt-4">
        ...
        {startModus === "gps" ? (
          ...
          <input value={sSuche} onChange={(e) => setSSuche(e.target.value)} placeholder="Startort suchen …" className={feld} />
      ...
      <div className="mt-4">
        ...
        {zielModus === "eingabe" ? (<>
          <input value={zSuche} onChange={(e) => setZSuche(e.target.value)} placeholder="Zielort suchen …" className={feld} />
