  ...
  return (
    <div className="space-y-2">
      ...
      <div className="overflow-hidden rounded-xl border border-stone-200 bg-sky-100" style={{ touchAction: "none" }}>
        <ComposableMap projection="geoMercator" projectionConfig={{ center: [6, 46], scale: 850 }} width={800} height={660} style={{ width: "100%", height: "auto" }}>
          <ZoomableGroup center={[6, 46]} zoom={1} minZoom={1} maxZoom={20}>
            {COUNTRIES.map((cc) => (
