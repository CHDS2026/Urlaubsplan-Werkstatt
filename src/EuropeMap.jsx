...
// Deutschland=Bundesländer, Schweiz=Kantone, Österreich=Bundesländer, Polen=Woiwodschaften, u. a.
const COUNTRIES = ["de", "at", "ch", "pl", "it", "fr", "es", "pt", "nl", "be", "lu", "cz", "sk", "hu", "si", "hr", "gr", "gb", "ie", "dk", "no", "se", "fi", "is", "ro", "bg", "rs", "ba", "al", "mk", "me", "ee", "lv", "lt", "ua"];
  ...
  return (
    <div className="space-y-2">
      ...
      <div className="overflow-hidden rounded-xl border border-stone-200 bg-sky-100" style={{ touchAction: "none" }}>
        <ComposableMap projection="geoConicConformal" projectionConfig={{ rotate: [-14, -52, 0], scale: 720 }} width={800} height={640} style={{ width: "100%", height: "auto" }}>
          <ZoomableGroup center={[14, 52]} zoom={1} minZoom={1} maxZoom={20}>
            {COUNTRIES.map((cc) => (
