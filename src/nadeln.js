...
const GLYPH = {
  ...
  // Berg mit zweiter Spitze
  gipfel:
    '<path d="M3.9 12.9 L7.4 6.4 L9.4 9.5 L10.7 7.4 L14.1 12.9 Z" fill="#fff"/>' +
    '<path d="M6.7 8.2 L7.9 7.4 L8.7 8.4" fill="none" stroke="#7c3aed" stroke-width="0.9" stroke-linejoin="round"/>',
  // Fahrrad
  radtour:
...
function nadelSVG(kategorie, opts) {
  ...
  return (
    ...
    '<path d="M9 0C4 0 0 4 0 9c0 6.6 9 17 9 17s9-10.4 9-17c0-5-4-9-9-9z" fill="' + info.farbe + '" stroke="#fff" stroke-width="1.5"/>' +
    glyph +
    "</svg>"
  );
}
