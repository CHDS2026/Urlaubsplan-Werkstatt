...
import { Lightbulb, Sparkles, CalendarDays, CalendarRange, Compass, ArrowLeftRight, Plane, Thermometer, ChevronLeft, ChevronRight, Tag } from "lucide-react";
...
export const GROUPS = [
  {
    ...
    items: [
      { k: "wochen", label: "Wochen-Tipps", desc: "Was lohnt sich wann ab Celle?", Icon: CalendarRange, C: Wochentipps, add: false },
  ...
  },
  {
    ...
    items: [
      { k: "region", label: "Region-Check", desc: "Infos, Wetter & Vor Ort zur Region", Icon: Compass, C: Region, add: true },
