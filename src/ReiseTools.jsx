...
export const GROUPS = [
  {
    g: "1 · Wohin? Ideen finden", gIcon: Lightbulb,
    items: [
  ...
  {
    g: "2 · Ziel prüfen: Region & Wetter", gIcon: Compass,
    items: [
  ...
  },
  {
    ...
    items: [
      ...
      { k: "angebote", label: "Günstig-Radar", desc: "Wohin ist es ab Celle/Hannover gerade billig?", Icon: Tag, C: Angebote, add: false },
    ],
  },
];
  ...
  return (
    <div className="w-full space-y-5 text-stone-800 dark:text-stone-200">
      <div className="rounded-2xl bg-emerald-700 px-4 py-3 text-white shadow-sm dark:bg-emerald-800">
        ...
        <p className="mt-0.5 text-sm text-emerald-50">In drei Schritten zur Reise: Ideen finden → Ziel prüfen → Anreise &amp; Preise. Tipp einfach an, was du brauchst.</p>
      </div>
