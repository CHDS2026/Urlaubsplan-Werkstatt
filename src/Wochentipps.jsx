...
const SEASON = {
  1: { title: "Skisaison in den Alpen", place: "Tirol / Südtirol" }, 2: { title: "Ski & Winterwandern", place: "Alpen" },
  3: { title: "Städtetrip vor der Saison", place: "Prag / Wien" }, 4: { title: "Frühling am See", place: "Gardasee / Südtirol" },
  5: { title: "Alpen-Roadtrip", place: "Dolomiten" }, 6: { title: "Lange Tage & Lavendel", place: "Provence / Skandinavien" },
  7: { title: "Bergseen & Küste", place: "Kärnten / Kroatien" }, 8: { title: "Norden & Alpen", place: "Norwegen / Tirol" },
  9: { title: "Weinlese & Toskana", place: "Toskana / Südtirol" }, 10: { title: "Indian Summer", place: "Harz / Alpen" },
  11: { title: "Therme & Städtetrip", place: "Budapest / Wien" }, 12: { title: "Weihnachtsmärkte & Ski", place: "Nürnberg / Wien / Alpen" },
};
...
export default function Wochentipps({ onCreateTrip }) {
  ...
  const planEvent = (e) => onCreateTrip && onCreateTrip({ name: e.title, gebiet: e.ort, info: "Anreise: " + e.note + (e.vorlaeufig ? " · Termin 2027 noch vorläufig" : ""), start: e.start, end: e.end });
  const planSeason = (w) => onCreateTrip && onCreateTrip({ name: w.season.title, gebiet: w.season.place, info: "Saison-Tipp ab Celle", start: w.a, end: w.b });
