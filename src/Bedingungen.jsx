...
export default function Bedingungen({ embedded = false, defaultQuery = "" }) {
  const [q, setQ] = useState(defaultQuery || "Innsbruck");
  ...
  async function run(q0) {
    const term = (q0 != null ? q0 : q).trim(); if (!term || geoLoad) return;
